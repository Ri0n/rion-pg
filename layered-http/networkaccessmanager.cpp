...
public:
	NetworkAccessManager2 *q;
	QNetworkDiskCache cache;
	QHash<QString, NetworkSchemeHandler*> schemeHandlers;

public:
	NetworkAccessManagerPrivate(NetworkAccessManager2 *nam) :
		q(nam) {}
...
//--------------------------------------------
NetworkAccessManager2::NetworkAccessManager2(QObject *parent) :
	QNetworkAccessManager(parent),
	d(new NetworkAccessManagerPrivate(this))
{
}

NetworkAccessManager2::~NetworkAccessManager2()
{
	delete d;
}

QNetworkDiskCache &NetworkAccessManager2::cache() const
{
	return d->cache;
}

void NetworkAccessManager2::setSchemeHandler(const QString &scheme,
											NetworkSchemeHandler *handler)
{
	d->schemeHandlers[scheme] = handler;
}

QNetworkReply* NetworkAccessManager2::createRequest(
